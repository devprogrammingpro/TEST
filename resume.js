$(document).ready(function(){
    ...
    $('#add-job-btn').click(function(){
        document.getElementById('job-list').innerHTML +=    `<div >
                                                               
                                                                <div >
                                                                    <div class='content-desc-text' contenteditable="true">éspace à ajouter</div>
                                                                    <!--div class="content-item-desc-item"><div class='content-desc-text' contenteditable="true">éspace à ajouter</div><div class="delete-info fa fa-trash" onclick="deleteFromList(this)"></div></div>
                                                                    <div class="content-item-desc-item"><div class='content-desc-text' contenteditable="true">éspace à ajouter</div><div class="delete-info fa fa-trash" onclick="deleteFromList(this)"></div></div>
                                                                    <div class="content-item-desc-item"><div class='content-desc-text' contenteditable="true">éspace à ajouter</div><div class="delete-info fa fa-trash" onclick="deleteFromList(this)"></div></div->
                                                                </div>
                                                            </div>`;
